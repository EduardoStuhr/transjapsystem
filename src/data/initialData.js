...
export const INITIAL_SERVICES = [
  ...
  },
  {
    ...
    baseProductivity: 1427,
    productivityUnit: "hora",
    efficiency: 1.00,
    referenceUnitCost: 1.00,
    referenceUnitPrice: 1.10,
    markup: 1.10,
    ...
    observacao: "Camada vegetal superficial. Raspa 20cm em geral.",
  },
  {
    id: uid(),
    ...
    unit: "M³",
    category: "Transporte",
    desc: "Transporte interno do material vegetal raspado para armazenamento no terreno",
    baseProductivity: 120,
    efficiency: 1.00,
    modoPrecoDefault: "preco_cravado",
    precoCravadoSugerido: 7.21,
    referenceUnitCost: 7.21,
    referenceUnitPrice: 7.21,
    markup: 1.00,
    observacao: "Transporte interno em local indicado pelo contratante. DMT ≤ 1km. Preço de mercado consagrado.",
    servicoRelacionado: "Limpeza de Camada Vegetal",
    formulaQuantidade: "area_pai × espessura_camada",
  },
  {
    id: uid(),
