---
name: dev-composicao-preco-orcamento
description: Implementa no sistema de orçamento a visualização auditável da composição de preço por item (UI + costEngine detalhado). Use quando o usuário pedir “ver composição de preço”, “detalhar cálculos”, “auditabilidade”, accordion/drawer por item, ou integração do costEngine com UI.
disable-model-invocation: true
---

# dev-composicao-preco-orcamento
